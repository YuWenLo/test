...
def conv_bn(in_channels, out_channels, kernel_size, stride, padding, groups=1):
    ...
    result.add_module('bn', nn.InstanceNorm2d(num_features=out_channels))
    return result
...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if deploy:
            ...
            self.rbr_identity = nn.InstanceNorm2d(num_features=in_channels) if out_channels == in_channels and stride == 1 else None
